...
const api_url = "https://script.google.com/macros/s/AKfycbwOvrr-2Etjj6inklpOROUGL1AbhtJxchhNBmoC2-qBCgeWTqffaWcjmNkHyT2nMGRJfQ/exec"
// "https://script.google.com/macros/s/AKfycbwNAW-94Z4SrWWolLA6fSgt8QTylZ-GA-INcjwi2sXUGsZlL7nirDTIiJL0xZw_QMF6Fw/exec"
...
listx_query_2 = `cmd=listx&index=2`
listx_query_all = `cmd=listx&subcmd=all`
...
btn_2.addEventListener("click", (e) => {
  ev_hdr(e, listx_query_2)
})
btn_all.addEventListener("click", (e) => {
  ev_hdr(e, listx_query_all)
})
